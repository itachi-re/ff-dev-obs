...
# The vendored .cargo-checksum.json expects libcubeb/.gitmodules to be empty.
# Truncate it to match rather than patching the checksum JSON.
> third_party/rust/cubeb-sys/libcubeb/.gitmodules
# FIX WM CLASS
